  ...
  return (
    <div className="w-full text-[#0A0A0A]">
      ...
      <section className="py-20 md:py-24 bg-[#EDEDEA] border-b border-black/10 relative overflow-hidden">
        <div className="absolute top-0 right-1/3 w-[500px] h-[500px] bg-[#04703D]/15 rounded-full blur-[140px] pointer-events-none -z-10" />
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="rounded-3xl bg-white border border-black/10 p-7 sm:p-8 shadow-2xl">
              ...
              <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#0A0A0A] mb-1">
                30 Minute Call
              </h3>
              <div className="font-mono text-sm font-bold text-[#04703D] mb-4">Starting at $50</div>
              <p className="text-xs sm:text-sm text-[#0A0A0A]/70 leading-relaxed mb-6 font-sans">
              ...
              <div className="space-y-3 mb-6 font-mono text-xs text-[#0A0A0A]/80">
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-[#04703D] text-white font-mono text-xs font-bold uppercase tracking-wider hover:bg-[#059C54] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg"
              >
                <Calendar className="w-4 h-4" />
                <span>Book a call</span>
              </button>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-3xl bg-white border border-black/10 p-7 sm:p-10 shadow-2xl">
              ...
              <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#0A0A0A] mb-2">
                Submit Your Systems Requirements
              </h3>
              <p className="text-xs text-[#0A0A0A]/60 mb-8">
                Tell us about your team and what feels messy. We'll reply within 24 to 48 hours with an initial audit assessment.
              </p>

              {formSubmitted ? (
                <div className="p-8 rounded-2xl bg-[#059C54] border border-[#04703D] text-center space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-[#0A0A0A]/80 max-w-md mx-auto">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-black/10 text-[#0A0A0A] text-xs font-mono uppercase tracking-wider hover:bg-black/20 transition-colors"
                  >
                    Submit another note
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 font-mono text-xs">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#0A0A0A]/60 mb-1.5 uppercase text-[10px]">Your Name *</label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white border border-black/10 text-[#0A0A0A] placeholder-white/30 focus:border-[#04703D] focus:outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-[#0A0A0A]/60 mb-1.5 uppercase text-[10px]">Work Email *</label>
                      <input
                        type="email"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#0A0A0A]/60 mb-1.5 uppercase text-[10px]">Company Name</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-[#0A0A0A]/60 mb-1.5 uppercase text-[10px]">Team Size</label>
                      <select
                        value={formData.teamSize}
                        onChange={e => setFormData({ ...formData, teamSize: e.target.value })}
                        className="w-full px-4 py-3 rounded-xl bg-white border border-black/10 text-[#0A0A0A] focus:border-[#04703D] focus:outline-none"
                      >
                  ...
                  <div>
                    <label className="block text-[#0A0A0A]/60 mb-2 uppercase text-[10px]">Tools Currently In Your Stack (Select All That Apply):</label>
                  ...
                  <div>
                    <label className="block text-[#0A0A0A]/60 mb-1.5 uppercase text-[10px]">What is your #1 operational bottleneck right now? *</label>
                    <textarea
                      required
                      rows={3}
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl bg-[#04703D] text-white font-bold text-xs uppercase tracking-wider hover:bg-[#059C54] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
                  >
            ...
            {FAQ_ITEMS.map((faq, idx) => (
              ...
              >
                <button
                  ...
                  className="w-full p-5 text-left flex items-center justify-between gap-4 font-serif text-lg font-bold text-[#0A0A0A] hover:text-[#04703D] transition-colors cursor-pointer"
                >
                  <span>{faq.q}</span>
                  {openFaqIdx === idx ? (
                    <ChevronUp className="w-5 h-5 text-[#04703D] flex-shrink-0" />
                  ) : (
                    <ChevronDown className="w-5 h-5 text-[#0A0A0A]/40 flex-shrink-0" />
                  )}
                </button>
                
                {openFaqIdx === idx && (
                  <div className="px-5 pb-5 text-xs sm:text-sm text-[#0A0A0A]/70 leading-relaxed font-sans border-t border-black/5 pt-3">
                    {faq.a}
                  </div>
                )}
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-8 rounded-3xl bg-white border border-black/10">
          <div>
            <span className="text-xs font-mono text-[#0A0A0A]/40 uppercase">RETURN TO TOP</span>
            <h4 className="font-serif text-2xl font-bold text-[#0A0A0A]">
