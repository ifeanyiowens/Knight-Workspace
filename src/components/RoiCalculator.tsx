...
export const RoiCalculator: React.FC<RoiCalculatorProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section id="calculator" className="py-24 bg-[#EDEDEA] text-[#0A0A0A] border-b border-black/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 border border-black/10 text-[#04703D] text-xs font-mono uppercase tracking-widest mb-3">
            <Calculator className="w-3.5 h-3.5 text-[#04703D]" />
            <span>Interactive Operational Audit</span>
          </div>
          
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#0A0A0A] tracking-tight leading-tight mb-4">
            Calculate your operational leakage.
          </h2>
          
          <p className="text-base sm:text-lg text-[#0A0A0A]/70 leading-relaxed font-sans">
        ...
        <div className="rounded-3xl bg-white border border-black/10 shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-6 p-7 sm:p-9 lg:p-11 border-b lg:border-b-0 lg:border-r border-black/10 space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-mono uppercase tracking-wider text-[#0A0A0A]/80">
                ...
                <input
                  ...
                  className="w-full h-2 bg-black/10 rounded-lg appearance-none cursor-pointer accent-[#04703D]"
                />
                <div className="flex justify-between text-[10px] font-mono text-[#0A0A0A]/40">
                  <span>01 (Solo)</span>
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="w-full h-2 bg-black/10 rounded-lg appearance-none cursor-pointer accent-[#04703D]"
                />
                <p className="text-xs text-[#0A0A0A]/50 font-sans">
            ...
            <div className="lg:col-span-6 p-7 sm:p-9 lg:p-11 bg-white text-[#0A0A0A] flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="mb-6 p-6 rounded-2xl bg-[#059C54] border border-[#04703D]/40 shadow-xl">
                  <span className="text-xs font-mono uppercase tracking-wider text-[#0A0A0A]/80 block mb-1">
                    Hours Reclaimed Annually
                  </span>
                  <div className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0A0A0A] tracking-tight mb-2">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="p-4 rounded-2xl bg-red-50 border border-red-200">
                    <span className="text-[11px] font-mono text-[#0A0A0A]/50 block mb-1">Current Annual Leakage</span>
                ...
                <div className="space-y-2 mb-6">
                  <div className="flex items-center gap-2 text-xs text-[#0A0A0A]/80 font-mono">
                    <CheckCircle2 className="w-4 h-4 text-[#04703D] flex-shrink-0" />
