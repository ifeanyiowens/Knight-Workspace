          ...
          <button
            ...
            className={`px-2 py-0.5 rounded text-[10px] uppercase tracking-wider transition-colors cursor-pointer ${
              activeTab === 'workspace'
                ...
                : 'text-[#16201B]/60 hover:text-[#16201B]'
            }`}
          >
            Workspace
          </button>
          ...
          <div className="space-y-3 animate-in fade-in duration-200">
            ...
            <div className="flex items-center justify-between text-[11px] pb-2 border-b border-black/5">
              <span className="text-[#16201B]/70 flex items-center gap-1.5 font-bold">
                <span className="text-[#1C3A5E]">📁</span> {client} Master Operations
              </span>
            ...
            <div className="space-y-2 text-[11px]">
              {studyId === 'louis-lessor' && (
                <>
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between hover:border-[#1C3A5E]/40 transition-colors">
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-[#1C3A5E]" />
                      <span className="text-[#16201B] font-medium">Lead: Marcus Vance (Tier 1)</span>
                    </div>
                ...
                <>
                  ...
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#16201B] font-medium">Cadence: Check-in Due (14d)</span>
                    </div>
              ...
              {studyId === 'vultures-vzw' && (
                <>
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    ...
                    <span className="px-2 py-0.5 rounded bg-[#059C54] text-[#1C3A5E] text-[10px] border border-[#1C3A5E]/30">
                      8 Relational Bases
                    </span>
                  </div>
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#16201B] font-medium">Onboarding Pipeline Auto-Webhook</span>
                    </div>
                    <span className="px-2 py-0.5 rounded bg-blue-900/60 text-blue-300 text-[10px] border border-blue-500/30">
                      Synced 100%
                    </span>
              ...
              {studyId === 'client-management-system' && (
                <>
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-[#1C3A5E]" />
                      <span className="text-[#16201B] font-medium">Stage 03: Production Delivery</span>
                    </div>
              ...
              {studyId === 'marcus-system' && (
                <>
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-blue-400" />
                      <span className="text-[#16201B] font-medium">Wholesale Stock: Core SKU #408</span>
                    </div>
                    <span className="px-2 py-0.5 rounded bg-blue-900/60 text-blue-300 text-[10px] border border-blue-500/30">
                ...
                <>
                  ...
                  <div className="p-2.5 rounded-xl bg-black/5 border border-black/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#16201B] font-medium">Bench Production & QA Setting</span>
                    </div>
            ...
            {/* Quick Metrics Tag */}
            <div className="pt-2 flex items-center justify-between text-[10px] text-[#16201B]/50 border-t border-black/5">
              <span>Auto-Rollups Active</span>
              <span className="text-[#1C3A5E]">Permissions: Scoped</span>
            </div>
          </div>
        )}
        ...
        {activeTab === 'automation' && (
          <div className="space-y-3 animate-in fade-in duration-200">
            <div className="flex items-center justify-between text-[11px] pb-1">
              <span className="text-[#1C3A5E] font-bold flex items-center gap-1.5">
                <Zap className="w-3.5 h-3.5" /> Make.com 4-Node Scenario
              </span>
              <button
                onClick={handleTriggerPulse}
                className="px-2 py-0.5 rounded bg-[#1C3A5E]/20 text-[#1C3A5E] border border-[#1C3A5E]/40 hover:bg-[#1C3A5E] hover:text-white transition-colors cursor-pointer text-[10px]"
              >
            ...
            <div className="grid grid-cols-4 gap-2 relative py-3 items-center">
              ...
              <div className="absolute left-4 right-4 top-1/2 -translate-y-1/2 h-0.5 bg-black/10 -z-0">
                <div
                  className={`h-full bg-gradient-to-r from-[#1C3A5E] to-emerald-400 transition-all duration-1000 ${
              ...
              {/* Node 1 */}
              <div className="z-10 p-2 rounded-xl bg-[#059C54] border border-[#1C3A5E]/40 text-center shadow-lg">
              ...
              <div className="z-10 p-2 rounded-xl bg-white border border-black/20 text-center shadow-lg">
                <span className="block text-[9px] text-[#16201B]/50 uppercase">02 Router</span>
                <span className="text-[10px] text-[#16201B] font-bold block truncate">Filter logic</span>
              </div>

              {/* Node 3 */}
              <div className="z-10 p-2 rounded-xl bg-white border border-black/20 text-center shadow-lg">
                <span className="block text-[9px] text-[#16201B]/50 uppercase">03 Database</span>
                <span className="text-[10px] text-[#16201B] font-bold block truncate">Notion DB</span>
              </div>
        ...
        {activeTab === 'schema' && (
          <div className="space-y-3 animate-in fade-in duration-200">
            <div className="flex items-center justify-between text-[11px] pb-1">
              ...
              <span className="text-[10px] text-[#16201B]/50">4 Linked DBs</span>
            </div>

            <div className="grid grid-cols-2 gap-2 text-[10px]">
              <div className="p-2.5 rounded-xl bg-black/5 border border-black/10">
                <div className="text-[#1C3A5E] font-bold mb-1">Accounts DB</div>
                <div className="text-[#16201B]/60 text-[9px] space-y-0.5">
              ...
              <div className="p-2.5 rounded-xl bg-black/5 border border-black/10">
                <div className="text-[#1C3A5E] font-bold mb-1">Deliverables DB</div>
                <div className="text-[#16201B]/60 text-[9px] space-y-0.5">
