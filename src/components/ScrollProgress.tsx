  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-[2.5px] bg-black/5 z-50 pointer-events-none">
        <div
          className="h-full bg-gradient-to-r from-[#059C54] via-[#04703D] to-[#059C54] transition-all duration-75"
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden md:flex items-center gap-2 bg-white backdrop-blur-md px-3.5 py-2 rounded-2xl border border-black/10 shadow-2xl">
        ...
        <span className="font-mono text-[10px] text-[#0A0A0A]/50 border-r border-black/10 pr-2.5 uppercase tracking-wider">
          <span className="text-[#04703D] font-bold">{activeSection}</span>
        </span>
        ...
        {scrollPercent > 20 && (
          <button
            onClick={scrollToTop}
            className="p-1 rounded-lg hover:bg-black/10 text-[#0A0A0A]/60 hover:text-[#04703D] transition-colors cursor-pointer"
            title="Scroll to top"
