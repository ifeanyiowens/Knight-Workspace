...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ onOpenBooking }) => {
  ...
  const getServiceIcon = (iconName: string) => {
    switch (iconName) {
      case 'LayoutGrid':
        return <LayoutGrid className="w-5 h-5 text-[#D4AF37]" />;
      case 'Cpu':
  ...
  return (
    <section id="services" className="py-24 bg-[#0C120F] text-[#EDEDEA] border-b border-white/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              ...
              className={`rounded-2xl p-7 transition-all cursor-pointer border flex flex-col justify-between ${
                selectedServiceId === service.id
                  ? 'bg-[#16201B] border-[#D4AF37] shadow-xl ring-1 ring-[#D4AF37]/30'
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    <span className="font-mono text-xs font-bold px-2.5 py-1 rounded-md bg-black/50 text-[#D4AF37] border border-[#D4AF37]/20">
                      0{idx + 1}
                    </span>
                    <div className="p-2 rounded-lg bg-[#1B4332]/60 border border-[#D4AF37]/30">
              ...
              <div>
                ...
                <button
                  ...
                  className="w-full py-2.5 px-3 rounded-xl text-xs font-mono font-semibold uppercase tracking-wider bg-white/5 text-white hover:bg-[#D4AF37] hover:text-[#111815] transition-colors flex items-center justify-center gap-1.5 cursor-pointer border border-white/10"
                >
        ...
        <div className="rounded-2xl bg-[#16201B] border border-white/10 p-7 sm:p-9 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          ...
          <button
            onClick={onOpenBooking}
            className="px-7 py-3.5 rounded-xl bg-[#D4AF37] text-[#111815] text-xs font-mono font-bold uppercase tracking-wider hover:bg-[#E5C358] transition-all flex items-center gap-2 flex-shrink-0 cursor-pointer shadow-lg"
          >
