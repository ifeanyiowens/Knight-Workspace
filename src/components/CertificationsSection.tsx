  ...
  return (
    <section id="certifications" className="py-24 bg-[#111815]/72 text-[#EDEDEA] border-b border-white/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-[#1B4332] text-white p-7 sm:p-9 flex flex-col md:flex-row items-center justify-between gap-6 border border-[#04703D]/30 shadow-2xl">
          <div className="space-y-2 text-center md:text-left">
            <div className="text-xs font-mono font-bold uppercase tracking-widest text-[#04703D]">
          ...
          <div className="flex-shrink-0 flex items-center gap-2 bg-[#111815] px-5 py-3 rounded-xl border border-[#04703D]/30 text-xs font-mono font-bold text-[#04703D]">
